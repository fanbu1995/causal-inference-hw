...
#### (d)
**(b)** is an approximation to **(a)** in that it doesn't use the **exact** distribution of the test statistic under randomized treatment assignment, but instead only approximates it using a bunch of random draws from the distribution. 

**(c)** is an approximation to **(a)** in that it doesn't explictly consider the assignment mechanism, but only compares the outcomes of the two groups. Also, it doens't consider potential outcomes for each individual either. 
